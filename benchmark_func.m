...
[ps,D]=size(x);
if initial_flag==0
    load 'datafiles/sphere_func_data.mat';
    if length(o)>=D
         o=o(1:D);
    else
         o=-100+200*rand(1,D);
...
[ps,D]=size(x);
if initial_flag==0
    load 'datafiles/schwefel_102_data.mat';
   if length(o)>=D
         o=o(1:D);
    else
         o=-100+200*rand(1,D);
...
[ps,D]=size(x);
if initial_flag==0
    load 'datafiles/high_cond_elliptic_rot_data.mat';
    if length(o)>=D
         o=o(1:D);
    else
         o=-100+200*rand(1,D);
    ...
    c=1;
    if D==2,load 'datafiles/elliptic_M_D2.mat',
    elseif D==10,load 'datafiles/elliptic_M_D10.mat',
    elseif D==30,load 'datafiles/elliptic_M_D30.mat',
    elseif D==50,load 'datafiles/elliptic_M_D50.mat',
    else 
...
if initial_flag==0
    initial_flag=1;
    load 'datafiles/schwefel_206_data.mat';
    if length(o)>=D
         A=A(1:D,1:D);o=o(1:D);
    else
         o=-100+200*rand(1,D);
...
[ps,D]=size(x);
if initial_flag==0
    load 'datafiles/rosenbrock_func_data.mat';
    if length(o)>=D
         o=o(1:D);
    else
         o=-90+180*rand(1,D);
...
[ps,D]=size(x);
if initial_flag==0
    load 'datafiles/griewank_func_data.mat';
    if length(o)>=D
         o=o(1:D);
    else
         o=-600+0*rand(1,D);
    ...
    c=3;
    if D==2,load 'datafiles/griewank_M_D2.mat',
    elseif D==10,load 'datafiles/griewank_M_D10.mat',
    elseif D==30,load 'datafiles/griewank_M_D30.mat',
    elseif D==50,load 'datafiles/griewank_M_D50.mat',
    else 
        M=rot_matrix(D,c);
...
[ps,D]=size(x);
if initial_flag==0
    load 'datafiles/ackley_func_data.mat';
    if length(o)>=D
         o=o(1:D);
    else
         o=-30+60*rand(1,D);
    ...
    c=100;
    if D==2,load 'datafiles/ackley_M_D2.mat',
    elseif D==10,load 'datafiles/ackley_M_D10.mat',
    elseif D==30,load 'datafiles/ackley_M_D30.mat',
    elseif D==50,load 'datafiles/ackley_M_D50.mat',
    else 
       M=rot_matrix(D,c);
    end
    initial_flag=1;
...
[ps,D]=size(x);
if initial_flag==0
    load 'datafiles/rastrigin_func_data.mat';
    if length(o)>=D
         o=o(1:D);
    else
         o=-5+10*rand(1,D);
...
if initial_flag==0
    ...
    c=2;
    if D==2,load 'datafiles/rastrigin_M_D2.mat',
    elseif D==10,load 'datafiles/rastrigin_M_D10.mat',
    elseif D==30,load 'datafiles/rastrigin_M_D30.mat',
    elseif D==50,load 'datafiles/rastrigin_M_D50.mat',
    else 
        M=rot_matrix(D,c);
    end
    initial_flag=1;
...
[ps,D]=size(x);
if initial_flag==0
    load 'datafiles/weierstrass_data.mat';
    if length(o)>=D
         o=o(1:D);
    else
         o=-0.5+0.5*rand(1,D);
    ...
    c=5;
    if D==2,load 'datafiles/weierstrass_M_D2.mat',
    elseif D==10,load 'datafiles/weierstrass_M_D10.mat',
    elseif D==30,load 'datafiles/weierstrass_M_D30.mat',
    elseif D==50,load 'datafiles/weierstrass_M_D50.mat',
    else 
        M=rot_matrix(D,c);
    end
    initial_flag=1;
...
if initial_flag==0
    initial_flag=1;
    load 'datafiles/schwefel_213_data.mat';
    if length(alpha)>=D
...
[ps,D]=size(x);
if initial_flag==0
    load 'datafiles/EF8F2_func_data.mat';
    if length(o)>=D
         o=o(1:D);
    else
         o=-1+1*rand(1,D);
...
[ps,D]=size(x);
if initial_flag==0
    load 'datafiles/E_ScafferF6_func_data.mat';
    if length(o)>=D
         o=o(1:D);
    else
         o=-100+200*rand(1,D);
    ...
    initial_flag=1;
    c=3;
    if D==2,load 'datafiles/E_ScafferF6_M_D2.mat',
    elseif D==10,load 'datafiles/E_ScafferF6_M_D10.mat',
    elseif D==30,load 'datafiles/E_ScafferF6_M_D30.mat',
    elseif D==50,load 'datafiles/E_ScafferF6_M_D50.mat',
    else 
       M=rot_matrix(D,c);
    end
end
...
if initial_flag==0
    ...
    initial_flag=1;
    fun_num=10;
    load 'datafiles/hybrid_func1_data.mat'; % saved the predefined optima
    if length(o(1,:))>=D
         o=o(:,1:D);
    else
...
if initial_flag==0
    ...
    if D==2,load 'datafiles/hybrid_func1_M_D2.mat',
    elseif D==10,load 'datafiles/hybrid_func1_M_D10.mat',
    elseif D==30,load 'datafiles/hybrid_func1_M_D30.mat',
    elseif D==50,load 'datafiles/hybrid_func1_M_D50.mat',
    else 
        for i=1:fun_num
...
if initial_flag==0
    ...
    initial_flag=1;
    fun_num=10;
    load 'datafiles/hybrid_func2_data.mat'; % saved the predefined optima
    if length(o(1,:))>=D
         o=o(:,1:D);
    else
         o=-5+10*rand(fun_num,D);
    ...
    if D==2,load 'datafiles/hybrid_func2_M_D2.mat',
    elseif D==10,load 'datafiles/hybrid_func2_M_D10.mat',
    elseif D==30,load 'datafiles/hybrid_func2_M_D30.mat',
    elseif D==50,load 'datafiles/hybrid_func2_M_D50.mat',
    else 
        for i=1:fun_num
            eval(['M.M' int2str(i) '=rot_matrix(D,c(i));']);
        end
...
if initial_flag==0
    ...
    initial_flag=1;
    fun_num=10;
    load 'datafiles/hybrid_func3_data.mat'; % saved the predefined optima, a 10*1000 matrix;
    if length(o(1,:))>=D
         o=o(:,1:D);
    else
         o=-5+10*rand(fun_num,D);
    ...
    lamda=repmat(lamda,1,D);
    c=ones(1,D);
    if D==2,load 'datafiles/hybrid_func3_M_D2.mat',
    elseif D==10,load 'datafiles/hybrid_func3_M_D10.mat',
    elseif D==30,load 'datafiles/hybrid_func3_M_D30.mat',
    elseif D==50,load 'datafiles/hybrid_func3_M_D50.mat',
    else 
        for i=1:fun_num
            A=normrnd(0,1,D,D);
...
if initial_flag==0
    ...
    if D==2,load 'datafiles/hybrid_func3_HM_D2.mat',
    elseif D==10,load 'datafiles/hybrid_func3_HM_D10.mat',
    elseif D==30,load 'datafiles/hybrid_func3_HM_D30.mat',
    elseif D==50,load 'datafiles/hybrid_func3_HM_D50.mat',
    else 
        for i=1:fun_num
            eval(['M.M' int2str(i) '=rot_matrix(D,c(i));']);
        end
...
if initial_flag==0
    ...
    initial_flag=1;
    fun_num=10;
    load 'datafiles/hybrid_func4_data.mat'; % saved the predefined optima, a 10*1000 matrix;
    if length(o(1,:))>=D
         o=o(:,1:D);
    else
         o=-5+10*rand(fun_num,D);
    ...
    if D==2,load 'datafiles/hybrid_func4_M_D2.mat',
    elseif D==10,load 'datafiles/hybrid_func4_M_D10.mat',
    elseif D==30,load 'datafiles/hybrid_func4_M_D30.mat',
    elseif D==50,load 'datafiles/hybrid_func4_M_D50.mat',
    else 
        for i=1:fun_num
            eval(['M.M' int2str(i) '=rot_matrix(D,c(i));']);
        end
